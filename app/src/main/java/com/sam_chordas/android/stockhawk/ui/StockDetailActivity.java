...
public class StockDetailActivity extends AppCompatActivity implements
  ...
  private void fillLineSet() {
    mCursor.moveToFirst();
    for (int i = 0; i < mCursor.getCount(); i+=5) {
    ...
    mLineSet.setColor(ContextCompat.getColor(this, R.color.line_set))
        ...
        .setDotsStrokeColor(ContextCompat.getColor(this, R.color.line_stroke))
  ...
  private void initLineChart() {
    ...
    gridPaint.setColor(ContextCompat.getColor(this, R.color.line_paint));
    gridPaint.setStyle(Paint.Style.STROKE);
    gridPaint.setAntiAlias(true);
    gridPaint.setStrokeWidth(Tools.fromDpToPx(1f));
    lineChartView.setBorderSpacing(1)
        .setAxisBorderValues(minRange - 10, maxRange + 10)
